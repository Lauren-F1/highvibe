...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert retreat producer. Your task is to create a thoughtful, well-paced, day-by-day itinerary for a retreat based on the provided details.
...
2.  **Pacing:** Do not overschedule. Include downtime, free time, and meals.
...
4.  **Tone:** Be inspiring and professional.
