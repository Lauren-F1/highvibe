...
export default function AdminServicesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="font-headline text-3xl font-bold mb-6">Services</h1>
      ...
      <Card>
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="text-center py-16 text-muted-foreground">No services found.</div>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                {items.map(item => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <Link href={`/admin/users/${item.vendorId}`} className="text-sm hover:underline">
                        {item.vendorName}
                      </Link>
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                      <Button variant="outline" size="sm" asChild>
                        <Link href={`/admin/services/${item.id}`}>View</Link>
                      </Button>
                    </TableCell>
                  </TableRow>
                ))}
