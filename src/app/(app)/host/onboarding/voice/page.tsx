      ...
      <div className="max-w-3xl mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Let's set up your profile so you can start listing spaces and connecting with guides.
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center p-8">
            <h2 className="text-xl font-bold mb-4">Voice Onboarding Coming Soon</h2>
            <p className="text-muted-foreground mb-6">
              This is a placeholder for the voice-based onboarding flow. For now, you can proceed to your dashboard.
            </p>
