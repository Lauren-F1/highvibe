...
export default function CheckoutPage() {
    ...
    const handleConfirmBooking = async () => {
        ...
        if (applyCredit && credit && firestore) {
            const creditRef = doc(firestore, 'manifest_credits', credit.id);
            try {
                // In a real scenario, this would be part of a transaction
                // along with creating the booking document.
                await updateDoc(creditRef, {
                    status: 'redeemed',
                    redeemed_amount: discount,
                    redemption_booking_id: `booking_${retreatId}_${Date.now()}`,
                 ...
                 toast({
                    ...
                    description: 'Could not apply your credit. Please try again.',
                    variant: 'destructive'
                 });
        ...
        setTimeout(() => {
            ...
            router.push('/seeker/manifestations'); // Redirect to a confirmation/dashboard page
        }, 1000);
    };
    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12">
            <Card className="max-w-2xl mx-auto">
                ...
                <CardFooter>
                    <Button className="w-full" size="lg" onClick={handleConfirmBooking} disabled={isProcessing}>
