      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="font-headline text-4xl">Hello HighVibe Vendor</CardTitle>
            <CardDescription className="text-lg">
              Let’s build your profile so the right guides and hosts can find you. Choose how you’d like to get started.
            </CardDescription>
          </CardHeader>
